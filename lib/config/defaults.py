...
_C.FINETUNE.LR_FACTOR = 0.1
_C.FINETUNE.LR_STEP = [30, 50]
_C.FINETUNE.LR = 0.00001

_C.FINETUNE.OPTIMIZER = 'adam'
_C.FINETUNE.MOMENTUM = 0.0
_C.FINETUNE.WD = 0.0
_C.FINETUNE.NESTEROV = False
_C.FINETUNE.UNFROZEN = ['head']

_C.FINETUNE.BEGIN_EPOCH = 0
_C.FINETUNE.END_EPOCH = 60

_C.FINETUNE.RESUME = True
_C.FINETUNE.CHECKPOINT = ''

_C.FINETUNE.BATCH_SIZE_PER_GPU = 16
_C.FINETUNE.SHUFFLE = True
